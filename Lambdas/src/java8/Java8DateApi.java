...
public class Java8DateApi {
	...
	public static void main(String[] args) {
		...
		//Instant
		//Such an instantaneous point on the time-line is also represented by 
		//the class Instant. Instants can be used to create legacy java.util.Date objects.
		...
		//LocalTime
		//LocalTime represents a time without a timezone, e.g. 
		//10pm or 17:30:15. The following example creates two local times for the timezones defined above. 
		...
		//The sample demonstrates how to calculate new dates by adding or 
		//substracting days, months or years. Keep in mind that each manipulation returns a new instance.
		...
		DayOfWeek day1OfWeek = sylvester.getDayOfWeek();
		System.out.println(day1OfWeek);      // WEDNESDAY
		...
		Instant instantNew = sylvester.atZone(ZoneId.systemDefault())
		        .toInstant();

		Date legacyDate1 = Date.from(instantNew);
