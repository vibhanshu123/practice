...
public class HttpPostHit {
	...
	public static void main(String[] args) throws NullPointerException, HttpException, IOException {
		...
		String httpUrl = "http://172.16.29.242:8089/momtgw/ideaAirgateMOListner";
		...
		method.addParameter("unique_id", "7111006291600580538123456");
		method.addParameter("status", "success");
		method.addParameter("type", "deliverstatus");
		method.addParameter("da", "00358401234567");
		method.addParameter("rid","ashdgvas");
